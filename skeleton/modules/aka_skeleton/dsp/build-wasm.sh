...
emcc "$here/wasm.cpp" \
  ...
  -s EXPORTED_FUNCTIONS='["_aka_prepare","_aka_begin_blocks","_aka_push_block","_aka_commit_blocks","_aka_set_param","_aka_note_on","_aka_note_off","_aka_all_notes_off","_aka_process","_aka_active_voices","_aka_set_step","_aka_current_step","_malloc","_free"]' \
  -o "$out/engine.js"
